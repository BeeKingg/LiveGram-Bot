...
DEFAULT_START_TEXT = (
    "Hay, saya adalah bot asisstant ᴛᴀᴋɪᴄʜᴀɴ. Silahkan ketik pesanmu dibawah ini, nanti saya akan membalasanya Jika sudah online.\n"
    "───────────────────────\n"
    "©Manage by : @zxyune"
)
...
ONLINE_CHECK_START_TEXT = get_config(
    ...
    (
        ...
        "Jangan lupa join [Channel Support](https://t.me/BeKing_Bots)"
    )
)
# message to indicate,
